...
public class DefaultCinemaServiceImpl implements CinemaServiceApi {
    ...
    public List<BrandVO> getBrands(int brandId) {
        ...
        for (BrandDictT brand : brandDictTList) {
            ...
            if (flag) {
                brandVO.setIsActive(brand.getUuid() == 99);
            } else {
                brandVO.setIsActive(brand.getUuid() == brandId);
            }
    ...
    public List<HallTypeVO> getHallTypes(int hallType) {
        ...
        for (HallDictT hall : hallDictTList) {
            ...
            if (flag) {
                hallTypeVO.setIsActive(hall.getUuid() == 99);
            } else {
                hallTypeVO.setIsActive(hall.getUuid() == hallType);
            }
