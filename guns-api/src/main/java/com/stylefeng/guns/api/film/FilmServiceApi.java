...
public interface FilmServiceApi {
    ...
    /**
     * @param
     * @return java.util.List<com.stylefeng.guns.api.film.vo.BannerVO>
     * @Author yangjiayi
     * @Description // 获取banners
     * @Date 12:19 2020/7/19
     */
     ...
     * @Author yangjiayi
     * @Description // 获取热映影片
     * @Date 12:20 2020/7/19
     */
    FilmVO getHotFilms(boolean isLimit, int sortId, int catId, int sourceId, int yearId, int nowPage, int pageSize);
